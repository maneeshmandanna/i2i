    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          {session.isAdmin && (
            <Button variant="outline" onClick={() => router.push("/env-admin")}>
              Admin Panel
            </Button>
          )}
        ...
        <div className="text-center py-8">
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            <p className="text-sm text-green-800">
              ✅ <strong>Simple Login:</strong> Email and password
              authentication
              <br />
              ⚙️ <strong>Environment Variables:</strong> User management via
              Vercel
              <br />
              🔒 <strong>Secure Access:</strong> Only whitelisted users allowed
            </p>
          </div>
        </div>
      </div>
